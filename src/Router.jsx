  ...
  return (
    <BrowserRouter basename="/DutyWebTub2">
      <Routes>
        ...
        <Route path="/6-2/dashboard" element={<Dashboard className="6-2" dataset={dutyBase62} />} />
        <Route path="/2-3/dashboard" element={<Dashboard className="2-3" dataset={dutyBase23} />} />
